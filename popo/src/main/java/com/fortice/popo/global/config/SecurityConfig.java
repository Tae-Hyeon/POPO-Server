...
import com.fortice.popo.global.jwt.JwtAccessDeniedHandler;
import com.fortice.popo.global.jwt.JwtAuthenticationEntryPoint;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers("/**").permitAll() // 테스트를 위해 모두 허용
